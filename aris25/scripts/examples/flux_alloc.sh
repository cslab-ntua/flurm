...
python3 $BASE_DIR/scripts/jgf_gen.py --nodes "$CONTROL_NODE,$COMPUTE_NODELIST" --set "socket=$SOCKETS_PER_NODE" --set "numanode=$NUMA_PER_SOCKET" --set "core=$CORES_PER_NUMA" -o "$BASE_DIR/conf.d/$nodefile/aris.json"
